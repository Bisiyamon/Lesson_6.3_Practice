...
input_word = input("Введите словов на английском или русском: ")
changeRegWord = input_word.upper()


result_score = 0
for letter in changeRegWord:
    for key in scrabble:
        if letter == key:
            result_score += scrabble[key]

print("Суммарный счет слова: ", result_score)
